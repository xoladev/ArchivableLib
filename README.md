...
> [!NOTE]
> Можно добавлять свои темы через функцию (см. ниже)
...
-- Добавить свою тему ({ThemeName = string, Bg = Color3, ElementBG = Color3, Text = Color3, Accent = Color3, Close = Color3, PlaceHoldersColor = Color3, ElementActiveBG = Color3})
_G.ALib:NewTheme({ThemeName = string, Bg = Color3, ElementBG = Color3, Text = Color3, Accent = Color3, Close = Color3, PlaceHoldersColor = Color3, ElementActiveBG = Color3})
...
### 👌 Демонстрация - [Нажмите для просмотра](Demo.lua)
### 👌 Исходный код - [Нажмите для просмотра](lib.lua)
